...
"  events=[]",
"  async def cb(event,data): events.append({'event':event,'data':safe(data)})",
"  names=['NowPlayingInfo','NowPlayingInfoEvent']",
"  for n in names:",
"   try: api.listen_to(n,cb); await api.subscribe_event(n)",
